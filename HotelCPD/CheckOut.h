...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Location = System::Drawing::Point(337, 26);
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	try {
		conn->Open();
		MySqlCommand^ cmd1 = gcnew MySqlCommand("UPDATE rooms SET RoomStatus= 'N' WHERE RoomNumber = " + currPIDrm, conn);
