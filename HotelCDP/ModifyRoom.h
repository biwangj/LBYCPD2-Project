...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Location = System::Drawing::Point(401, 12);
			this->dataGridView1->MultiSelect = false;
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->SelectionMode = System::Windows::Forms::DataGridViewSelectionMode::FullRowSelect;
			this->dataGridView1->Size = System::Drawing::Size(454, 362);
			...
			// rmstats
			// 
			this->rmstats->Location = System::Drawing::Point(162, 136);
			...
			this->rmstatus->Location = System::Drawing::Point(48, 139);
			...
			this->add3->Location = System::Drawing::Point(47, 190);
			...
			this->add2->Location = System::Drawing::Point(48, 104);
			...
			// roomnum
			// 
			this->roomnum->Location = System::Drawing::Point(162, 37);
			...
			this->roomlabel->Location = System::Drawing::Point(48, 40);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(32, 330);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(281, 330);
			...
			// descri
			// 
			this->descri->Location = System::Drawing::Point(161, 190);
			...
			// quanti
			// 
			this->quanti->Location = System::Drawing::Point(162, 103);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(162, 330);
			...
			// roomtyp
			// 
			this->roomtyp->Location = System::Drawing::Point(161, 71);
			...
			this->pictureBox1->Size = System::Drawing::Size(880, 536);
			...
			this->ClientSize = System::Drawing::Size(867, 386);
