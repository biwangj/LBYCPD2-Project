...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Size = System::Drawing::Size(391, 303);
			...
			this->label1->Location = System::Drawing::Point(88, 82);
			...
			this->label2->Location = System::Drawing::Point(90, 129);
			...
			this->label3->Location = System::Drawing::Point(52, 176);
			...
			// adminbox1
			// 
			this->adminbox1->Location = System::Drawing::Point(149, 79);
			this->adminbox1->Name = L"adminbox1";
			this->adminbox1->Size = System::Drawing::Size(155, 20);
			this->adminbox1->TabIndex = 4;
			// 
			// adminbox2
			// 
			this->adminbox2->Location = System::Drawing::Point(149, 126);
			this->adminbox2->Name = L"adminbox2";
			this->adminbox2->Size = System::Drawing::Size(155, 20);
			this->adminbox2->TabIndex = 5;
			// 
			// adminbox3
			// 
			this->adminbox3->Location = System::Drawing::Point(149, 173);
			this->adminbox3->Name = L"adminbox3";
			this->adminbox3->Size = System::Drawing::Size(155, 20);
			this->adminbox3->TabIndex = 6;
			// 
			// label4
			// 
			this->label4->AutoSize = true;
			this->label4->Location = System::Drawing::Point(30, 47);
			...
			// adminreg1
			// 
			this->adminreg1->Location = System::Drawing::Point(242, 209);
			this->adminreg1->Name = L"adminreg1";
			this->adminreg1->Size = System::Drawing::Size(62, 25);
			...
			// adminreg3
			// 
			this->adminreg3->Location = System::Drawing::Point(33, 244);
			this->adminreg3->Name = L"adminreg3";
			this->adminreg3->Size = System::Drawing::Size(62, 25);
			...
			this->ClientSize = System::Drawing::Size(379, 291);
